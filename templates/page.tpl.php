...
<?php if($page['header_top']): ?>
 ...
 <?php endif ?><!---End Header Navigation --->
...
<div class="page-wrapper">
  <div id="header-wrapper">
    ...
    <?php endif; ?>
     ...
     <div id="navigation">
      <?php if ($main_menu): ?>
        <nav id="menu-bar" role="navigation" class="<?php print 'gpmenu'; ?> clearfix" >
          <?php if ($gpmenu): ?>
                  <?php print render($gpmenu); ?>
                <?php else: ?>
...
<div id="page">
	...
	<?php if ($useslideshow): ?>
	  <div id="gslideshow">
        <?php if ($slide_image): // Use lemma banners ?>
	...
	<div id="main">
		...
		<div id="main-content">
      <?php print $breadcrumb; ?> <!-- End Breadcrumb -->
	...
	<?php if($page['bottom_panel']): ?>
	<?php print render($page['bottom_panel']); ?>
	 <?php endif ?><!-- Bottom Panel -->
</div><!-- /#page -->
<div id="footer-panel-wrapper">
    <?php if($page['footer_panel']): ?>
	<div class="footer-panel clearfix  container">
		<?php print render($page['footer_panel']);  ?>
	</div>
	<?php endif ?><!--- End Footer Panel -->
</div>
